...
import static edu.cornell.libraries.orcidclient.auth.AuthorizationStateProgress.NO_URI;
import static edu.cornell.libraries.orcidclient.testwebapp.support.WebappSetup.WEBAPP_CACHE_FILE_KEY;
